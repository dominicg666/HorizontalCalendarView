...
class HorizontalCalendarAdapter extends RecyclerView.Adapter<HorizontalCalendarAdapter.DayViewHolder> {
    ...
    public void onBindViewHolder(DayViewHolder holder, int position) {
        ...
        if (position == selectedItemPosition) {
            ...
            holder.txtDayName.setTextSize(horizontalCalendar.getTextSizeDayName()*3f);
            holder.txtDayNumber.setTextSize(horizontalCalendar.getTextSizeDayNumber()*3f);

            holder.layoutBackground.setBackgroundColor(horizontalCalendar.getSelectedDateBackground());
            holder.layoutBackground.setBackground(horizontalCalendar.getSelectedDateBackgroundDrawable());
        ...
        // Unselected Days
            ...
            holder.txtDayName.setTextSize(horizontalCalendar.getTextSizeDayName());
            holder.txtDayNumber.setTextSize(horizontalCalendar.getTextSizeDayNumber());
        }
