...
public class HorizontalCalendarView extends RecyclerView {
    ...
    public HorizontalCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            selectedDateBackgroundDrawable = a.getDrawable(R.styleable.HorizontalCalendarView_selectedDateBackgroundDrawable);
    ...
    public void setHorizontalCalendar(HorizontalCalendar horizontalCalendar) {
        ...
        if(horizontalCalendar.getSelectedDateBackgroundDrawable()==null){
            horizontalCalendar.setSelectedDateBackgroundDrawable(selectedDateBackgroundDrawable);
        }
