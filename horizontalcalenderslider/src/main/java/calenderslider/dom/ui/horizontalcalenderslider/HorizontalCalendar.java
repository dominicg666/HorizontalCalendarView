package calenderslider.dom.ui.horizontalcalenderslider;
...
public class HorizontalCalendar {
    ...
    private Drawable selectedDateBackgroundDrawable;
    //endregion
    ...
    private HorizontalCalendar(Builder builder) {
        ...
        this.selectedDateBackgroundDrawable=builder.selectedDateBackgroundDrawable;
    ...
    public Drawable getSelectedDateBackgroundDrawable(){
        return selectedDateBackgroundDrawable;
    }

    public void setSelectedDateBackgroundDrawable(Drawable selectedDateBackgroundDrawable){
        this.selectedDateBackgroundDrawable=selectedDateBackgroundDrawable;
    }
    //endregion
    ...
    public static class Builder {
        ...
        int selectorColor;
        private float textSizeMonthName, textSizeDayNumber, textSizeDayName;
        Drawable selectedDateBackgroundDrawable;
        ...
        public Builder selectedDateBackgroundDrawable(Drawable selectedDateBackgroundDrawable){
            this.selectedDateBackgroundDrawable=selectedDateBackgroundDrawable;
            return this;
        }
